<!--
  Ce component est une version modifiée du package npm
...
export default {
  ...
  methods: {
    ...
    onLeftThumbMouseup() {
      ...
      this.$emit("deposer-curseur", [
        this.labels[this.valueMin],
        this.labels[this.valueMax]
      ]);
    },
